      ...
      <div className="container py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a href="#" className="p-2 border-2 border-foreground rounded-md hover:bg-accent transition-colors" aria-label="Discord">
            ...
            <a href="#" className="p-2 border-2 border-foreground rounded-md hover:bg-accent transition-colors" aria-label="Facebook">
              <Facebook className="h-4 w-4" />
            </a>
            <a href="#" className="p-2 border-2 border-foreground rounded-md hover:bg-accent transition-colors" aria-label="Instagram">
              <Instagram className="h-4 w-4" />
            </a>
            <a href="#" className="p-2 border-2 border-foreground rounded-md hover:bg-accent transition-colors" aria-label="Twitter">
              <Twitter className="h-4 w-4" />
            </a>
            <a href="#" className="p-2 border-2 border-foreground rounded-md hover:bg-accent transition-colors" aria-label="QR Code">
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M3 3h8v8H3V3zm2 2v4h4V5H5zm8-2h8v8h-8V3zm2 2v4h4V5h-4zM3 13h8v8H3v-8zm2 2v4h4v-4H5zm13-2h3v2h-3v-2zm-3 0h2v3h-2v-3zm3 3h3v2h-3v-2zm0 3h3v3h-3v-3zm-3 0h2v3h-2v-3z"/>
              </svg>
            </a>
          </div>
        </div>
